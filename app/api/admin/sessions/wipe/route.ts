...
/**
 * Danger: deletes ALL session rows (blobs live inline and cascade) for
 * every project the calling admin owns. Requires the admin session
 * cookie AND a confirmation header so we don't fat-finger it.
 *
